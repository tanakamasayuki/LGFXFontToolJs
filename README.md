...
| [Generator](https://tanakamasayuki.github.io/LGFXFontToolJs/generator.html) | TTF / Google Fonts → u8g2 / GFXfont `.h`, with charset selection, fallback fill-in and automatic attribution |
...
<script type="module">
  import { loadFont, drawString }
    from 'https://cdn.jsdelivr.net/npm/lgfx-font-tool@1.0.0/dist/lgfx-font-tool.min.js';
</script>
```
